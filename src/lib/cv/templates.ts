...
export const TEMPLATE_DEFS: TemplateDef[] = [
  ...
  { ...base, id: "international", name: "International", description: "Personal details table and banded headings.", bestFor: "Europe, Middle East & Asia applications", category: "ATS", atsFriendly: true, header: "details", entry: "traditional", defaults: { font: "Roboto", accent: "#1f2937", margin: 16 } },
  ...
  { ...base, id: "contemporary", name: "Contemporary", description: "Accent bars and a three-column skills grid.", bestFor: "Marketing, sales, business", category: "Professional", atsFriendly: true, header: "split", skills: "columns", defaults: { font: "IBM Plex Sans", accent: "#b45309", margin: 16 } },
  ...
  { ...base, id: "creative", name: "Creative", description: "Colour header band with a skills sidebar.", bestFor: "Design, marketing, networking", category: "Creative", atsFriendly: false, header: "band", layout: "sidebar-left", sidebarSections: SIDEBAR, defaults: { font: "Lato", accent: "#0f766e", margin: 14 } },
  { ...base, id: "twocolumn", name: "Clean Two-Column", description: "Main column with a tinted side panel.", bestFor: "Networking, career fairs", category: "Creative", atsFriendly: false, layout: "sidebar-right", sidebarSections: SIDEBAR, defaults: { font: "Source Sans 3", accent: "#2b4c9a", margin: 14 } },
  { ...base, id: "sidebar", name: "Modern Sidebar", description: "Bold colour sidebar with contact and skills.", bestFor: "Creative and client-facing roles", category: "Creative", atsFriendly: false, layout: "sidebar-left", sidebarSections: SIDEBAR, contactInSidebar: true, headerInMain: true, defaults: { font: "Lato", accent: "#1f3a5f", margin: 12 } },
  { ...base, id: "timeline", name: "Timeline", description: "Career shown as a vertical timeline.", bestFor: "Portfolios, career changers", category: "Creative", atsFriendly: false, entry: "timeline", defaults: { font: "Source Sans 3", accent: "#0f766e", margin: 15 } },
];
